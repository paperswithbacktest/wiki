...
The volatility effect has been observed not only in the US market but also in European and Japanese markets. This suggests that this anomaly is not limited to one region or type of market, but may be an inherent feature of global financial markets. It is also possible to combine the volatility effect with other strategies, such as momentum and reversal.

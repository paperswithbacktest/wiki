...
[1]: Li, M., Andersen, D. G., Park, J. W., Smola, A. J., Ahmed, A., Josifovski, V., Long, J., Shekita, E. J., & Su, B. Y. (2014). ["Scaling Distributed Machine Learning with the Parameter Server."](https://www.usenix.org/system/files/conference/osdi14/osdi14-paper-li_mu.pdf) In Proceedings of the 11th USENIX Symposium on Operating Systems Design and Implementation (OSDI 14).

[2]: Zheng, X., Tu, D., Zhang, S., Ma, C., & Kulesza, A. (2017). ["Asynchronous Stochastic Gradient Descent with Delay Compensation."](https://arxiv.org/abs/1609.08326) Advances in Neural Information Processing Systems 30.

[3]: Dean, J., Corrado, G. S., Monga, R., Chen, K., Devin, M., Le, Q. V., Mao, M. Z., Ranzato, M., Senior, A., Tucker, P., Yang, K., & Ng, A. Y.  (2012). ["Large Scale Distributed Deep Networks."](https://dl.acm.org/doi/10.5555/2999134.2999271) Advances in Neural Information Processing Systems 25.

[4]: Abadi, M., Barham, P., Chen, J., Chen, Z., Davis, A., Dean, J., Devin, M., Ghemawat, S., Irving, G., Isard, M., Kudlur, M., Levenberg, J., Monga, R., Moore, S., Murray, D. G., Steiner, B., Tucker, P., Vasudevan, V., Warden, P., … & Zheng, X. (2016). ["TensorFlow: A System for Large-Scale Machine Learning."](https://arxiv.org/abs/1603.04467) In 12th USENIX Symposium on Operating Systems Design and Implementation (OSDI 16).

[5]: Paszke, A., Gross, S., Massa, F., Lerer, A., Bradbury, J., Chanan, G., Killeen, T., Lin, Z., Gimelshein, N., Antiga, L., Desmaison, A., KÃ¶pf, A., Yang, E., DeVito, Z., Raison, M., Tejani, A., Chilamkurthy, S., Steiner, B., Fang, L., … & Lerer, A. (2019). ["PyTorch: An Imperative Style, High-Performance Deep Learning Library."](https://arxiv.org/abs/1912.01703) Advances in Neural Information Processing Systems 32.
---
title: "Investment in Mid-Cap Companies"
...
Market capitalization (market cap) is a critical financial metric that measures the total value of a company's outstanding shares of stock. It is calculated by multiplying the current share price by the total number of outstanding shares:

$$
\text{Market Capitalization} = \text{Share Price} \times \text{Total Outstanding Shares}
$$

This measure is vital as it allows investors to categorize companies into groups such as small-cap, mid-cap, and large-cap, each with different risk and return profiles.

Mid-cap companies have a market capitalization that typically falls between $2 billion and $10 billion. This classification places them in a unique space within the market spectrum. They are often seen as having passed the initial volatile growth phase of small-cap companies but not yet reached the maturity levels of large-cap firms. This intermediate status offers a blend of growth potential and stability, making mid-cap companies appealing to many investors.
...
[1]: Wilshire Associates. (2022). ["Size Effect: Small vs. Large vs. Mid-Cap Stocks"](https://www.moneyunder30.com/small-cap-vs-mid-cap-vs-large-cap/).
...
[6]: ["Introduction to Algorithmic Trading Strategies"](https://onlinelibrary.wiley.com/doi/epdf/10.1002/9781119206033.fmatter) by Nasdaq.

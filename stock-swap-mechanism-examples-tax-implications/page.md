...
- **Type 'C' Reorganizations**: In these reorganizations, the acquiring company exchanges its stock for assets of the target company. At least 80% of the value of the target’s property must be acquired using the acquirer's voting stock to fulfill tax-free requirements.

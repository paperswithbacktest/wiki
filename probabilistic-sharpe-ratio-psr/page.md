...
The Probabilistic Sharpe Ratio (PSR) is an advanced risk-adjusted return metric that enhances the traditional Sharpe Ratio by addressing its limitations, specifically concerning the distributional assumptions of asset returns. Developed by David H. Bailey and Marcos López de Prado, the PSR offers a more comprehensive tool for evaluating the performance of [trading strategies](/course/volume-profile-indicator-trading-strategies) by incorporating skewness and kurtosis into its calculations.

...
To figure out the accrued interest, you count the number of days from the last interest payment date to the date you're calculating the price. Then, you multiply the number of days by the bond's daily interest rate. The daily interest rate is the bond's annual coupon rate divided by the number of days in the year. Once you have the accrued interest, you subtract it from the market price. The result is the clean price of the bond. This gives you a clear picture of the bond's value without the extra interest that has built up.

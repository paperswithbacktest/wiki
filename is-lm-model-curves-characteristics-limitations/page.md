...
Fiscal policy changes, investment sentiment shifts, or variations in the money supply can cause the IS or LM curves to shift. For instance, an expansionary fiscal policy may increase aggregate demand, shifting the IS curve to the right, whereas a contractionary policy would shift it to the left. Similarly, a change in the central bank's monetary policy might shift the LM curve through adjustments in the money supply or interest rate targets. These shifts alter the equilibrium point, impacting overall economic conditions such as GDP and interest rates.

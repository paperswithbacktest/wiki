...
Another criticism is that the Order Protection Rule might not always work the way it's supposed to. Sometimes, the best price shown on one exchange might not be real, and this can trick people into thinking they are getting a good deal when they're not. This is called "latency arbitrage," where fast traders can take advantage of small delays in the system. Critics say that this can make the market less fair, even with the rule in place. Overall, while the rule aims to protect investors, some say it can also create new problems that need to be fixed.

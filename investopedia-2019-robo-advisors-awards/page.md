---
title: "Investopedia 2019 Robo-Advisors Awards"
...
The process begins with an assessment of the investor’s risk tolerance, investment goals, and time horizons. These parameters are quantitatively analyzed to create a risk profile. Once established, the algorithm employs a range of strategies, including Modern Portfolio Theory (MPT), to achieve optimal diversification. The formula for calculating the expected return of a portfolio, according to MPT, is:
...
[5]: Kelleher, J.D., Mac Namee, B., & D’Arcy, A. (2015). ["Fundamentals of Machine Learning for Predictive Data Analytics: Algorithms, Worked Examples, and Case Studies"](https://mitpress.mit.edu/9780262029445/fundamentals-of-machine-learning-for-predictive-data-analytics/) MIT Press. 

[6]: Obermeyer, Z., & Emanuel, E.J. (2016). ["Predicting the Future — Big Data, Machine Learning, and Clinical Medicine"](https://pubmed.ncbi.nlm.nih.gov/27682033/) New England Journal of Medicine.
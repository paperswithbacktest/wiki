...
A persistent current account deficit means a country is spending more on imports than it is earning from exports over a long time. This can put pressure on the country's currency to become weaker. When a country buys more from other countries than it sells, it needs to use its own money to pay for those imports. If this keeps happening, other countries will have a lot of the country's money, which can make them less interested in holding onto it. They might sell it, which makes the currency's value go down.

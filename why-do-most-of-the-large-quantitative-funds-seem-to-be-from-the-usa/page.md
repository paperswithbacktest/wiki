...
As computational power increased, the rise of algorithmic trading in the 1970s and 1980s further accelerated the growth of quantitative funds. Pioneers like Ed Thorp, who applied quantitative methods to beat the markets, demonstrated the potential of mathematical models in forecasting market trends and pricing anomalies. His hedge fund, Princeton Newport Partners, became one of the first and most successful quant funds of its time, achieving stellar returns while highlighting the transformative power of quantitative finance.

...
The most commonly traded currencies in the [forex](/wiki/forex-system) market are the US dollar, the Euro, the Japanese yen, the British pound, and the Australian dollar. These currencies are often called the "major currencies" because they are used a lot in trading. The US dollar is the most traded currency because it is used in many international transactions and is considered a safe and stable currency.

...
The key distinction between these spreads lies in Z-spread's focus on interest rate risk and OAS's incorporation of option-related risks. While the Z-spread offers a tidy uniform adjustment over interest rates, OAS delves into the stochastic nature of interest rates and option exercises, making it particularly useful for bonds with embedded options such as callable bonds or mortgage-backed securities.

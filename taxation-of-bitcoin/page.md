...
The tax implications of cryptocurrency transactions hinge significantly on the duration the asset is held before being disposed of. For assets held for less than a year, any gains are classified as short-term and taxed at ordinary income rates, which can range from 10% to 37% depending on the taxpayer’s income bracket. Conversely, assets held for more than a year are eligible for long-term capital gains tax rates, which are generally lower, ranging from 0% to 20%, depending on the individual taxpayer's taxable income.

Accurately determining gains or losses on [cryptocurrency](/wiki/cryptocurrency) transactions necessitates meticulous record-keeping of each transaction's cost basis. The cost basis is essentially the original value of the cryptocurrency, accounting for factors like the purchase price and transaction fees. When calculating gains or losses, the cost basis is subtracted from the proceeds of the sale to determine the taxable amount. The following formula can be used to express this calculation:

$$
\text{Capital Gain/Loss} = \text{Selling Price} - \text{Cost Basis}
$$

If the result is positive, a capital gain occurs, and if negative, it indicates a capital loss, which could potentially offset other gains.
...
The tax liability generated from these transactions depends on the concept of capital gains and losses, which are calculated based on the difference between the sale price and the asset's cost basis. The formula used to determine capital gain or loss is:
...
Where:
- $\text{Cost Basis}$ is the original value of the asset, including all acquisition costs.
- $\text{Sale Price}$ is the amount received upon selling the asset.

Furthermore, specific Bitcoin-related events such as mining, gifting, and receiving cryptocurrencies through forks have unique tax implications. 

**Mining Bitcoin:** Income derived from mining is considered taxable. The fair market value of the mined Bitcoin at the time of receipt is recognized as income and is subject to ordinary income tax rates. Additionally, if a miner later sells the mined Bitcoin, they must report this transaction for capital gains tax calculation.

**Gifting Bitcoin:** When Bitcoin is gifted, tax does not generally apply to the giver. However, the recipient may face tax implications when they decide to sell the gifted Bitcoin. The cost basis for the recipient is typically the same as the donor’s basis unless the market value on the date of the gift is lower than the donor's cost basis.
...
[1]: Internal Revenue Service. ["Virtual Currencies."](https://www.irs.gov/individuals/international-taxpayers/frequently-asked-questions-on-virtual-currency-transactions) 

[2]: OECD. ["Taxing Virtual Currencies: An Overview Of Tax Treatments And Emerging Tax Policy Issues"](https://www.oecd-ilibrary.org/taxation/taxing-virtual-currencies_e29bb804-en) 

[3]: Casey, M. J., & Vigna, P. (2015). ["The Age of Cryptocurrency: How Bitcoin and the Blockchain Are Challenging the Global Economic Order"](https://archive.org/details/ageofcryptocurre0000vign)

[4]: Nakamoto, S. (2008). ["Bitcoin: A Peer-to-Peer Electronic Cash System"](https://nakamotoinstitute.org/library/bitcoin/)

[5]: De Filippi, P., & Wright, A. (2018). ["Blockchain and the Law: The Rule of Code"](https://www.jstor.org/stable/j.ctv2867sp)
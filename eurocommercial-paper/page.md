...
1. **Exchange Rate Risk**: Issuing ECPs denominated in foreign currencies exposes issuers to exchange rate fluctuations, which can affect the cost of funds when converting proceeds back into the issuer’s home currency.

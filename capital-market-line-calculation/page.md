...
When the risk-free rate changes, it shifts the whole Capital Market Line. If the risk-free rate goes up, the starting point of the CML moves up too. This means that for the same amount of risk, you can now get a higher return because the safe part of your investment is earning more. On the other hand, if the risk-free rate goes down, the starting point of the CML moves down. This means you'll get a lower return for the same level of risk because the safe part of your investment is earning less.

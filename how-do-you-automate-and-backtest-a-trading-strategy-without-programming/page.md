---
title: Building Automated Trading Strategies with No-Code Platforms
description: No-code trading platforms enable you to automate strategies through intuitive
  menus backtesting live data and risk management to optimize performance. Discover
  more inside.
---
...
After setting your rules, you'll need to test your strategy to see if it works well. Most platforms have a [backtesting](/wiki/backtesting) feature where you can see how your strategy would have done in the past. This helps you see if your rules make sense and if you might make money with them. If the backtesting shows your strategy loses money, you can change your rules and test again until you find something that works. Once you're happy with your strategy, you can turn on the automation feature, and the platform will buy and sell based on your rules without you having to do anything.

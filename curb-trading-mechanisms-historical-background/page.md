...
As technology advanced, particularly during the late 20th and early 21st centuries, algorithmic trading began to grow rapidly. This was bolstered by increasing computational power and the development of sophisticated financial software. Trading activities that once required human oversight began to be executed at a much faster pace, driven by algorithms designed to optimize trade execution based on a set of programmed criteria.

A notable evolution of algorithmic trading is high-frequency trading ([HFT](/wiki/high-frequency-trading-strategies)), which has become a prominent component of market transactions. HFT employs complex algorithms to analyze multiple markets and execute a large [volume](/wiki/volume-trading-strategy) of orders within microseconds. The goal of HFT is to capture small price inefficiencies across different markets or securities, which cumulatively can yield substantial profits. This form of trading relies heavily on technological infrastructure, including low-latency data feeds and strategic positioning of servers near exchange platforms to minimize transmission times, a practice known as colocation.
...
[4]: Degryse, H., Jong, F. D., & Van Kervel, V. (2015). [The Impact of Dark Trading and Visible Fragmentation on Market Quality](https://econpapers.repec.org/RePEc:oup:revfin:v:19:y:2015:i:4:p:1587-1622.). The Journal of Economic Perspectives, 29(3), 101-124.

[5]: Hasbrouck, J. (2007). ["Empirical Market Microstructure: The Institutions, Economics, and Statistics of Securities Trading."](https://archive.org/details/empiricalmarketm0000hasb) Oxford University Press.

[6]: Patterson, S. (2012). ["Dark Pools: The Rise of the Machine Traders and the Rigging of the U.S. Stock Market."](https://www.amazon.com/Dark-Pools-Machine-Traders-Rigging/dp/0307887189) Crown Business.

[7]: Gomber, P., Arndt, B., Lutat, M., & Uhle, T. (2011). [High-Frequency Trading](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=1858626) Review of Futures Markets, 20(1), 129-162.
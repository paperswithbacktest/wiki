...
Some investors shy away from diversification, operating under the assumption that it might dilute returns. However, this belief overlooks the nuanced relationship between risk and return. Properly diversified portfolios are designed to mitigate unsystematic risk—risk specific to individual assets—which does not necessarily compromise overall returns. Instead, diversification often reduces portfolio [volatility](/wiki/volatility-trading-strategies), thereby providing a smoother return experience across different market conditions.

...
Fundamental analysis is a way to look at the real value of a company or an asset by studying things like its earnings, the economy, and other big factors. When you use [fundamental analysis](/wiki/fundamental-analysis) in your trading strategy, you're trying to find out if a stock or another asset is priced too high or too low. For example, if a company's earnings are growing but its stock price isn't, you might think the stock is a good buy because it could go up in the future. By understanding the basics of a company, you can make smarter choices about when to buy or sell.

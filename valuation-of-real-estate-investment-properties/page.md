...
Next, you use the net operating income to find the property's value. You do this by dividing the NOI by something called the capitalization rate, or cap rate. The cap rate is like an interest rate that shows how much return investors expect to get from this kind of property. For example, if your NOI is $50,000 and the cap rate is 5%, you divide $50,000 by 0.05 to get a value of $1,000,000. The income approach is really helpful for investors because it shows how much money a rental property can make, which helps them decide if it's a good investment.

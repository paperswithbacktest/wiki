...
In the Gordon Growth Model, there are three main variables that help figure out the value of a stock. The first variable, "D1," stands for the dividend that the company is expected to pay next year. This is important because it's the starting point for figuring out how much money you might get from the stock in the future. The second variable, "r," is the required rate of return. This is the percentage of return that an investor wants to get from the stock. It's like the [interest rate](/wiki/interest-rate-trading-strategies) you want when you invest your money.

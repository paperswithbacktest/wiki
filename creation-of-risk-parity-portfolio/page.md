...
Another technique is using "factor-based investing." This means you look at what makes investments go up or down, like how big a company is or how fast it's growing. By choosing investments that have different factors, you can spread out the risk even more. This can help your portfolio do better in different market conditions because it's not just based on one type of investment. Both of these techniques can help make a risk parity portfolio stronger and more able to handle different market situations.

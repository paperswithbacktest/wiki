...
[2]: Jurafsky, D., & Martin, J. H. (2009). ["Speech and Language Processing"](https://www.researchgate.net/publication/200111340_Speech_and_Language_Processing_An_Introduction_to_Natural_Language_Processing_Computational_Linguistics_and_Speech_Recognition) (2nd Edition). Prentice Hall.

[3]: Bird, S., Klein, E., & Loper, E. (2009). ["Natural Language Processing with Python."](https://www.researchgate.net/publication/220691633_Natural_Language_Processing_with_Python) O'Reilly Media.

[4]: Zhang, Y., & Wallace, B. (2015). ["A Sensitivity Analysis of (and Practitioners’ Guide to) Convolutional Neural Networks for Sentence Classification."](https://aclanthology.org/I17-1026/) Proceedings of the 8th International Conference on Computational Linguistics.

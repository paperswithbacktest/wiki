...
Non-compliance with SEC regulations can have significant consequences. Penalties may include fines or sanctions that impact the ability of the ATS to operate effectively. In severe cases, failure to meet compliance standards can lead to the revocation of an ATS’s exemption from registering as a national exchange, consequently halting its operations.

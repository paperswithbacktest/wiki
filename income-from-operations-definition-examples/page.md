...
When figuring out income from operations, businesses often need to make some adjustments to their numbers. One common adjustment is to take out any money made or lost from things that are not part of the main business, like selling off old equipment or [earning](/wiki/earning-announcement) interest from investments. These are not related to the company's main job, so they are not included in income from operations. Another adjustment is to remove any one-time or unusual costs, like the money spent on a big lawsuit or a natural disaster. These costs do not happen every day and can make the numbers look worse than they really are.

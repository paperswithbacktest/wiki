...
The primary applications in algo trading are augmenting small alternative data samples for ML training, generating stress-test scenarios for strategy robustness evaluation, privacy-preserving data sharing (e.g., sharing anonymized transaction data), and backtesting strategies across a wider range of market conditions than history provides.

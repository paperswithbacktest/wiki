...
Inflation can make it hard to compare numbers from different years if you don't use a base year. Imagine you want to see if people are earning more money now than they did ten years ago. If you just look at the numbers, it might seem like people are earning more, but that could be because of inflation. Inflation means that the value of money goes down over time, so the same amount of money buys less stuff. By using a base year, you can adjust the numbers to see what they would be worth in today's money, making the comparison fair.

...
Chartism can be used with other trading methods to make a complete plan that looks at the market from different angles. For example, chartists can use [fundamental analysis](/wiki/fundamental-analysis), which looks at things like company earnings and economic reports, to get a better idea of what's going on. By combining chart patterns with this information, traders can see if the price movements make sense with what's happening in the real world. They might also use quantitative analysis, which uses math and numbers to find patterns. This can help confirm the patterns they see on the charts and make their predictions more accurate.

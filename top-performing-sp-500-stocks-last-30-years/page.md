...
Another stock that did very well is Amazon. It started as an online bookstore but grew into a huge company selling all kinds of things. Its stock price has gone up a lot because of its growth and new businesses like cloud computing. Finally, there's NVIDIA, which makes computer chips. It has done really well because of the demand for its chips in gaming and artificial intelligence. These companies have given investors big returns because they kept growing and making more money over the last 30 years.

...
Another strategy is called long/short equity. This is similar to market neutral investing but focuses more on picking specific stocks. The index buys stocks it thinks will go up (long) and sells short stocks it thinks will go down (short). By doing this, the index tries to make money from the difference between the winners and losers, no matter what the overall market does.
...
Absolute Return Indices handle market volatility by using strategies that aim to make money no matter what the market is doing. Instead of trying to beat the market, these indices focus on achieving a specific positive return. They do this by balancing investments that might go up with investments that might go down. For example, they might buy some stocks and also sell other stocks short. This way, if the market goes down, the short sales can make money to offset any losses from the stocks that were bought.

...
Another problem is that the Upside/Downside Ratio doesn't show how risky an investment is in other ways. For example, it doesn't tell you about how much the price of the investment can change in a short time, which is called [volatility](/wiki/volatility-trading-strategies). An investment could have a good ratio but still be very up and down, which might not be good for someone who doesn't like a lot of risk. So, while the ratio can give you some good information, it's best to use it along with other tools and information to make smart choices about investments.

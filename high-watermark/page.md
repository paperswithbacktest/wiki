...
Also, as more people care about things like environmental, social, and governance (ESG) issues, high watermarks might be used in new ways. Fund managers might start to include these issues when they set high watermarks, so they get paid not just for making money, but also for doing good things for the world. This could make high watermarks more complicated but also more meaningful. Regulators might also step in more to make sure high watermarks are used in ways that are fair and good for investors, especially as the world of investing keeps changing.

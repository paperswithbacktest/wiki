...
Because machine learning is so good at recognizing faces, it can be used in ways that might not be good for our privacy. For example, companies might use it to follow what we do and where we go, and then use that information to show us ads or even sell it to other people. Governments might use it to keep an eye on people in public places. This can make us feel like we're always being watched, and it can be hard to stop because the technology keeps getting better and better. So, it's important to think about how we can use machine learning in a way that respects our right to privacy.

...
Refining is how we turn raw oil into things we use every day, like gasoline for cars or jet fuel for airplanes. When oil comes out of the ground, it's a thick, dark liquid called [crude oil](/wiki/crude-oil). To use it, we need to clean it up and break it down into different parts. This happens at a place called a refinery. First, the crude oil is heated up in a big tower called a distillation column. As it gets hot, different parts of the oil turn into gas at different temperatures and rise up the tower. The gases cool down at different levels and turn back into liquids, which are collected. This separates the oil into things like gasoline, diesel, and kerosene.

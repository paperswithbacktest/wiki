...
[1]: Rosenblatt, F. (1958). ["The Perceptron: A Probabilistic Model for Information Storage and Organization in the Brain."](https://psycnet.apa.org/record/1959-09865-001) Psychological Review.

[2]: Goodfellow, I., Bengio, Y., & Courville, A. (2016). ["Deep Learning."](https://www.deeplearningbook.org/) MIT Press.

[3]: Hagan, M. T., Demuth, H. B., Beale, M. H., & De Jesús, O. (2014). ["Neural Network Design."](https://www.amazon.com/Neural-Network-Design-Martin-Hagan/dp/0971732116) Martin Hagan.

[4]: Bishop, C. M. (2006). ["Pattern Recognition and Machine Learning."](https://link.springer.com/book/9780387310732) Springer.

[5]: Minsky, M., & Papert, S. (1969). ["Perceptrons."](https://en.wikipedia.org/wiki/Perceptrons_(book)) An Introduction to Computational Geometry. MIT Press.
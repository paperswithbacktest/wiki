...
Another strategy that electronic market makers use is called "statistical arbitrage." This is when they use math to find patterns in the market and make trades based on those patterns. They might buy something they think will go up in price and sell something they think will go down, trying to make a profit from the difference. Market makers also use "liquidity provision," where they make sure there's always someone ready to buy or sell, which keeps the market running smoothly. By using these strategies, electronic market makers can keep the market active and make small profits over time.

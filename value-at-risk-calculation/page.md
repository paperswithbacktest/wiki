...
To make Value at Risk (VaR) calculations more accurate, people can use something called "backtesting." Backtesting means looking back at how well the VaR number predicted what actually happened in the past. If the VaR number was right most of the time, then it's probably a good guess for the future. If it was wrong a lot, then you might need to change how you calculate VaR. Backtesting helps make sure your VaR is reliable and not just a guess.

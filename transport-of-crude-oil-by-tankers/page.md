...
Aframax and Panamax tankers are even smaller. Aframax tankers are often used for shorter trips and can go into ports that bigger tankers can't reach. Panamax tankers are designed to fit through the Panama Canal, which helps move oil between the Atlantic and Pacific Oceans. Each type of tanker has its own job, depending on how much oil needs to be moved and where it needs to go. This variety helps make sure that [crude oil](/wiki/crude-oil) can be transported efficiently and safely to where it is needed.

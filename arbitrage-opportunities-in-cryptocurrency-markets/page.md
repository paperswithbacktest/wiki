...
Advanced traders can use [algorithmic trading](/wiki/algorithmic-trading) to make arbitrage in cryptocurrency markets easier and faster. They use computer programs called algorithms to watch prices on different exchanges all the time. These algorithms can spot price differences very quickly and do the trades automatically. This means the trader doesn't have to watch the market all the time or do the trades by hand. It can save a lot of time and help them take advantage of more opportunities because the computer can act faster than a person.

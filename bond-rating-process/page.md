...
Even though these agencies look at similar things, they might come up with different ratings for the same bond. This is because each agency has its own way of deciding how important each factor is. For example, one agency might think the economy is more important than another agency does. This can make it confusing for investors, but it also gives them more information to think about. So, investors often look at ratings from more than one agency to get a better idea of how safe or risky a bond is.

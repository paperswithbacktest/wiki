...
On the other hand, [fundamental analysis](/wiki/fundamental-analysis) investigates into the intrinsic value of securities by evaluating a company's financial health, including revenue, earnings, future growth prospects, and management quality. It involves the examination of financial statements, competitive advantages, and market position to determine whether a stock is undervalued or overvalued. Fundamental analysts might employ techniques such as discounted cash flow (DCF) analysis to assess a company's value by estimating future cash flows and discounting them back to their present value.

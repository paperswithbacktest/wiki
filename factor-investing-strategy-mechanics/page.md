...
Factor investing and smart beta strategies are pretty similar. Both are about picking investments based on certain traits, like size, value, or momentum, instead of just following the overall market. Smart beta ETFs are a way to do factor investing easily. They are like regular ETFs, but they focus on these special traits. So, if you want to use the size factor, you can buy a smart beta ETF that picks smaller companies. This makes it easier for you to use factor investing without having to pick each stock yourself.

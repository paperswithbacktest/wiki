...
Convenience yield is influenced by several factors, mainly related to how useful it is to have something on hand. One big factor is how easy or hard it is to get the item when you need it. If it's hard to find or buy, the convenience yield goes up because having it ready to use is more valuable. Another factor is how much the item's price might change. If prices can go up a lot, people might want to keep the item instead of selling it, which increases the convenience yield.

...
Dollar-cost averaging (DCA) is a technique that involves investing a fixed amount of money at regular intervals, regardless of the asset’s price. By doing so, investors purchase more shares when prices are low and fewer shares when prices are high. This method helps to smooth out the effects of market [volatility](/wiki/volatility-trading-strategies) and reduces the risk associated with attempting to time the market. The regularity of contributions ensures that investments are made consistently, which can be particularly advantageous during periods of market downturns, ultimately lowering the average cost per share over time.

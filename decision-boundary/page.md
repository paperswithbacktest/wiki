...
[1]: Bishop, C. M. (2006). ["Pattern Recognition and Machine Learning"](https://www.cs.uoi.gr/~arly/courses/ml/tmp/Bishop_book.pdf). Springer. This book provides a comprehensive introduction to machine learning and pattern recognition, covering decision boundaries and other fundamental concepts.

[2]: Hastie, T., Tibshirani, R., & Friedman, J. (2009). ["The Elements of Statistical Learning: Data Mining, Inference, and Prediction"](https://link.springer.com/book/10.1007/978-0-387-84858-7). Springer. An essential read for understanding the statistical foundations of machine learning, including detailed explanations of decision boundaries.

[3]: Cortes, C., & Vapnik, V. (1995). ["Support-Vector Networks."](https://link.springer.com/article/10.1007/BF00994018) Machine Learning, 20(3), 273–297. This paper introduces support vector machines, focusing on optimizing decision boundaries with maximum margin.

[4]: Ng, A. (2004). ["Feature selection, L1 vs. L2 regularization, and rotational invariance."](https://dl.acm.org/doi/10.1145/1015330.1015435) Proceedings of the Twenty-first International Conference on Machine Learning. Discusses regularization techniques and their impact on decision boundaries.

[5]: Murphy, K. P. (2012). ["Machine Learning: A Probabilistic Perspective."](https://www.cs.ubc.ca/~murphyk/MLbook/pml-toc-1may12.pdf) MIT Press. Offers a probabilistic approach to machine learning that includes thorough coverage of decision boundaries in a variety of models.
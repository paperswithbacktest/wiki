---
title: Optimize and Automate Trading Strategies on TradeStation Platform
description: TradeStation offers automation testing and risk management tools to streamline
  strategy development and optimize trading Discover more inside.
---
...
TradeStation offers a variety of basic trading strategies that beginners can use to start trading. One common strategy is the moving average crossover, which helps traders decide when to buy or sell based on the movement of short-term and long-term moving averages. If the short-term average crosses above the long-term average, it might be a good time to buy. If it crosses below, it might be time to sell. Another basic strategy is the [breakout](/wiki/breakout-trading) strategy, where traders watch for a stock price to break through a certain level. If the price goes above a resistance level, it could be a signal to buy, and if it drops below a support level, it might be a signal to sell.

...
Finex, the Financial Instruments Exchange, began its operations in 1985 as a specialized arm of the New York Board of Trade (NYBOT). This establishment was a strategic response to the burgeoning demand for financial derivatives, particularly in the realm of currency markets. Finex focused primarily on trading currency derivatives such as [forex](/wiki/forex-system) futures and options, which played an essential role in providing traders with instruments for hedging and speculative strategies in volatile currency markets.

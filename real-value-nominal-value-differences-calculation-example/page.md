---
title: Nominal and Real Values Explained for Purchasing Power
description: Nominal and real values help you understand how inflation and price changes
  affect purchasing power and financial decisions. Discover more inside
---
...
Another example is with interest rates on savings accounts or loans. If a bank says they're giving you a 2% [interest rate](/wiki/interest-rate-trading-strategies) on your savings, that's the nominal rate. But if inflation is at 3%, the real interest rate is actually negative because the money in your account is losing value over time. For loans, a nominal interest rate of 5% might seem low, but if inflation is high, the real cost of borrowing could be much less because the money you pay back will be worth less in the future. Knowing this helps you make smarter choices about saving and borrowing money.

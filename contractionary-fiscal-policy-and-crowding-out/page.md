...
Where $\alpha, \beta, \gamma,$ and $\delta$ are predetermined parameters that denote the sensitivity of the asset allocation to interest rate changes. In a contractionary environment, as $r$ increases, the algorithm reduces $S$ and increases $B$, leading to potential sudden shifts in market [liquidity](/wiki/liquidity-risk-premium) and asset prices.

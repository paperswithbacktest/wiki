...
Pivot points can be used on different time frames, like daily, weekly, or even hourly charts. Traders choose the time frame based on how long they want to hold their trades. For short-term trading, like day trading, they might use hourly or 4-hour pivot points. For longer-term trading, like swing trading, they might use daily or weekly pivot points. The way you calculate pivot points stays the same no matter the time frame, but the levels will be different because they are based on the high, low, and closing prices of the chosen period.

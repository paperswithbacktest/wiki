...
Another way to get [alternative data](/wiki/best-alternative-data) is by using public sources. This can include things like government reports, weather data, or even news articles. Traders can use tools to scrape this information from the internet and turn it into useful data. For instance, someone might look at weather reports to predict how a bad storm could affect a company's sales.

...
**Short history**: Most alternative datasets span 5–10 years. With only ~40 quarterly observations per company, there are far more potential features than independent data points.

**Multiple testing**: Traders typically test dozens of signal definitions, parameter combinations, and universe filters before selecting one. Each test inflates the probability of finding a spuriously significant result.

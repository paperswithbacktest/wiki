---
title: Implementing a Risk Parity Strategy for Stable Portfolios
description: Risk parity balances portfolio risk across assets to reduce volatility
  and protect returns through market swings today Discover more inside.
---
...
Risk parity can be combined with [factor](/wiki/factor-investing) investing to create a more balanced and potentially more rewarding investment approach. Factor investing is about choosing investments based on certain characteristics, like how big a company is or how much its stock price goes up and down. By adding risk parity to factor investing, you can spread the risk evenly across different factors. This means that if one factor does badly, it won't hurt your whole portfolio too much. For example, if you're investing in factors like value and [momentum](/wiki/momentum), risk parity can help make sure that both factors contribute the same amount of risk to your portfolio.

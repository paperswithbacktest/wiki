...
One of the primary characteristics of OTC markets is their relative lack of regulation compared to major exchanges. This environment allows a wider variety of companies to participate, often resulting in smaller, less established, and potentially volatile entities engaging in trading. The less stringent regulatory framework, while beneficial for company inclusivity, also necessitates caution from investors due to the associated risks.

A notable feature of OTC trading is the larger bid-ask spread. This spread indicates the difference between the price at which sellers are willing to sell (ask) and the price buyers are willing to pay (bid). In OTC markets, this spread tends to be larger, primarily due to lower trading volumes and less [liquidity](/wiki/liquidity-risk-premium). The equation for the bid-ask spread can be expressed as:

$$
\text{Bid-Ask Spread} = \text{Ask Price} - \text{Bid Price}
$$

Larger spreads can lead to increased transaction costs for traders and reflect the difficulty in executing large orders without significantly impacting prices.
...
[1]: Frino, A., & Oetomo, T. N. (2005). ["The Impact of Algorithmic Trading on Market Liquidity: Evidence from the Sydney Futures Exchange."](https://www.etf.com/docs/Index%20Changes_Chen%20Norohha%20Singal.pdf?v=1735175976804) Journal of International Financial Markets, Institutions and Money.

[2]: Hasbrouck, J., & Saar, G. (2012). ["Technology and Liquidity Provision: The Blurring of Traditional Definitions."](https://www.sciencedirect.com/science/article/pii/S1386418108000220) Journal of Financial Markets.

[3]: Mitra, G., & Mitra, L. (Eds.). (2011). ["The Handbook of News Analytics in Finance."](https://onlinelibrary.wiley.com/doi/book/10.1002/9781118467411) Wiley.

[4]: FINRA. (2020). ["SEC Approves Rule Change to Eliminate the OTC Bulletin Board (OTCBB) Published Quotes."](https://www.finra.org/rules-guidance/rule-filings/sr-finra-2020-031) Financial Industry Regulatory Authority.
...
[7]: Malinova, K., & Park, A. (2013). ["Liquidity, Volume and Price Efficiency: The Impact of Order vs. Quote Driven Trading."](https://www.sciencedirect.com/science/article/pii/S138641811200033X) Journal of Financial Economics.
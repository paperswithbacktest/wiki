...
Another technology used is called mud logging. This involves using a special kind of mud that helps cool the drill bit and carry away pieces of rock. The mud also helps keep the hole from collapsing. While drilling, people check the mud to learn about the rocks they are drilling through and find out where the oil or gas might be. Also, companies use logging tools that go down the well to measure things like temperature and pressure. This information helps them understand the well better and make good decisions about how to get the oil or gas out.

...
Another important indicator is the [volume](/wiki/volume-trading-strategy) of trades. If more people are selling a stock than buying it, and the volume of trades is high, it can show that many people think the price will go down. This can be a strong sign of a bearish trend. Also, traders look at patterns on price charts, like the head and shoulders pattern. This pattern can signal that a stock's price is about to fall, which is another way to predict a bearish trend.

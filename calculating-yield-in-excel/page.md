---
title: Yield Calculation in Excel for Farming and Finance
description: Yield calculation in Excel helps you compute crop yields and bond returns
  using built in functions and automation with macros Discover more inside.
---
...
Another useful function is the EFFECT function, which helps you find out the effective annual yield when interest is compounded more than once a year. If you have a bond that pays 5% interest every six months, you can use '=EFFECT(0.10, 2)' to find the effective annual yield. The '0.10' is the total yearly [interest rate](/wiki/interest-rate-trading-strategies) (5% + 5%), and '2' means it's compounded twice a year. This function shows you how much your money would grow in a year if it was compounded at that rate, which is important for understanding the true yield of your investment.

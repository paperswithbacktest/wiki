...
Regulatory bodies have recognized the importance of disparate impact analysis in preventing unlawful discrimination. Organizations such as the Securities and Exchange Commission (SEC) stress the necessity of employing rigorous methods to identify and mitigate these biases. They advocate for using disparate impact analysis—a quantitative assessment tool that evaluates whether a particular algorithm or practice has disproportionate adverse effects on protected classes compared to other groups.

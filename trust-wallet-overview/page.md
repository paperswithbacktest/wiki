...
To add a new cryptocurrency to your Trust Wallet, first open the app on your phone. Once you're in, look at the bottom of the screen and tap on the "Receive" button. This will show you a list of all the cryptocurrencies that Trust Wallet supports. Scroll through the list until you find the cryptocurrency you want to add. If it's not there, it might not be supported yet, but Trust Wallet often adds new ones, so check back later.

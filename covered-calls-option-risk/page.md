...
Another way to manage early assignment risk is to choose a strike price that's far enough away from the current stock price. This makes it less likely that the stock will be called away early. Also, [picking](/wiki/asset-class-picking) an expiration date that's further out can help because it gives the stock more time to move around without getting called away. If you do get assigned early, you can always buy the stock back if you want to keep holding it. Just remember, managing early assignment risk is all about being prepared and watching the market closely.

...
But, the fund manager's impact isn't just about picking the right investments. They also need to manage the fund in a way that keeps costs low and follows the fund's goals. For example, if the fund is meant to be safe and steady, the manager needs to choose investments that match that goal. They also have to think about how often they buy and sell investments, because doing this too much can make the fund's costs go up. So, a good fund manager can make a big difference in how well a mutual fund does, by picking good investments and managing the fund well.

...
Another thing to consider is the [interest rate](/wiki/interest-rate-trading-strategies). If interest rates are high, the cost of the options might be different because money today is worth more than money in the future. You should also think about any dividends or costs related to the asset, like storage costs for commodities. All these things together help you figure out the price of a synthetic forward contract. It's like putting together a puzzle to make sure you end up with the right price to match what you'd get from a traditional forward contract.

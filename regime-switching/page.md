...
Another tool that's often used is R, which is a free software that's great for statistics and data analysis. R has packages like "MSwM" and "depmixS4" that are made just for regime switching models. These packages help users to set up the models, look at past data, and guess how likely it is for the economy or market to switch states. R is liked by many because it's free and has a big community of people who share tips and tricks for using it.

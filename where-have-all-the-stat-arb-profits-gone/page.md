...
Statistical arbitrage, often abbreviated as stat arb, is a sophisticated trading strategy used in the financial markets to exploit price discrepancies between related financial instruments. Unlike traditional arbitrage which aims to capitalize on price differences in identical instruments across different markets, statistical arbitrage leverages mathematical models and statistical techniques to identify and profit from relative value mispricings. 

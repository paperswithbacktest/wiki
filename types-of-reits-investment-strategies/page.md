...
Another key factor is the financial health of the REIT. You want to check if the REIT is making enough money to pay its bills and still give you dividends. Look at things like the REIT's funds from operations (FFO), which is a bit like profit but more specific to real estate. Also, see how much debt the REIT has. Too much debt can be risky, especially if interest rates go up. Finally, consider the management team. A good team can make smart decisions that help the REIT grow and keep paying dividends.

...
Several factors can change the price of an amortizing swap. The most important one is the interest rates. If interest rates go up, the value of the swap to the person paying the fixed rate might go down, because they're locked into a lower rate. The opposite is true if rates go down. Another factor is how the notional principal decreases. If it goes down faster or slower than expected, that can change the value of the swap. Also, the creditworthiness of the people involved matters. If one party looks riskier, the other might want a higher rate to make up for that risk. All these things together help decide what the swap is worth.

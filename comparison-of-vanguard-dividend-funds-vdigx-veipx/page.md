...
Alpha is another metric that looks at how well a fund does compared to what you would expect from the market. A positive Alpha means the fund did better than expected. For VDIGX, you might see a positive Alpha if the companies it picks do well and grow their dividends. This means VDIGX might beat the market because it's [picking](/wiki/asset-class-picking) companies that can do better than average. For VEIPX, the Alpha might be smaller because it focuses more on steady income rather than beating the market. So, VEIPX might not have as high an Alpha, but it's still a good choice if you want a reliable income without too much risk.

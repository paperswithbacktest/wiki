...
Net interest margin (NIM) is an important number that helps investors understand how well a bank is doing with its main job: making money from the difference between what it charges for loans and what it pays for deposits. NIM is found by taking the difference between the interest income from loans and the interest expense on deposits, then dividing that by the bank's total [earning](/wiki/earning-announcement) assets. A higher NIM means the bank is doing a good job at making money from its loans and managing the cost of its deposits. When investors see a high NIM, it can make them feel more confident about the bank's ability to earn profits.
